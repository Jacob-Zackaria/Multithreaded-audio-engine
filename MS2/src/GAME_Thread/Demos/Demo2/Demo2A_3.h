...
class Demo2A_3 : public Command
{
public:
	Demo2A_3(int time) : newTime(time) {}
	~Demo2A_3() = default;
	Demo2A_3(const Demo2A_3&) = delete;
	Demo2A_3& operator = (const Demo2A_3&) = delete;
